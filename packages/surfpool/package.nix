...
let
  ...
  hashes = {
    "darwin-arm64" = "sha256-T0ASpdy+Ar18kj5uiPVY98VRQFOdxrtDa52vTgveOKA=";
    "darwin-x64" = "sha256-SanKijy5i3ioj1n+Lfnp2fNgXMDWejXyxNH46umheZ4=";
    "linux-x64" = "sha256-q7FFHi342nHbyzidC9WRk56Eivn1I3kmNItVyIaJZkA=";
  };
in
stdenv.mkDerivation {
  pname = "surfpool";

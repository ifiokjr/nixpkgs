...
let
  ...
  hashes = {
    "darwin-arm64" = "sha256-z9y4m2Q2EeqNDYmKo87Ug6dyZ0K3F2H9Dd1PSeiEjik=";
    "darwin-x64" = "sha256-xf3BCbR2km1FCMt2NYTZzH4HHB4p7suYC3BNffd97Rk=";
    "linux-x64" = "sha256-pSeXe4u1Ia/4gEy4M5Wskpci2umFoiHtPl9t1IpjiEY=";
  };
in
stdenv.mkDerivation {
  pname = "surfpool";

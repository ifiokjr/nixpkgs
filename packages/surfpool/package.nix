...
let
  ...
  hashes = {
    "darwin-arm64" = "sha256-ijgBVGvyZ2W1b+WU6/lDgoUbppu5v4kxrW7kOWrDlMU=";
    "darwin-x64" = "sha256-5MNVfmJpwBZpu0AS8qM77fjKaFObBsbl4POENrRYG5A=";
    "linux-x64" = "sha256-2AL7K8bJPRClaBjIzk7ViZoYWDRamCzoJwkhhe0KiR4=";
  };
in
stdenv.mkDerivation {
  pname = "surfpool";

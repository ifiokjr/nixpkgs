...
let
  ...
  hashes = {
    "darwin-arm64" = "sha256-NSEk3A4pLCnyS5MFiD8Wunr9ar0d3O9f4E9UORbnmWM=";
    "darwin-x64" = "sha256-PiElyww031v19pam36ObEXheaIO4rBqHA6/68oqnjS4=";
    "linux-x64" = "sha256-tVxnfjIZlDSYx+GH3CZsTyTjhBKOv6WcBG4rIs7pDVg=";
  };
in
stdenv.mkDerivation {
  pname = "surfpool";

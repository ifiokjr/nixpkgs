...
```bash
nix run github:ifiokjr/nixpkgs#melos_6 -- --help
```
...
This package is pinned to the latest 6.x `melos` version published to Pub and builds from the matching `melos-v<version>` GitHub tag. Use the `melos` output for the default track.

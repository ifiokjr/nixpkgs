...
| `monostyle`                                                                                                                                         | linux, macOS           | Code complexity and readability scorer                               |
...
| `serverpod`, `serverpod-cli`, `serverpod_cli`, `serverpod_cli-3`, `serverpod_cli-4`                                                                 | linux, macOS           | Serverpod command-line tools (4.x default; 3.x track retained)       |
...
| `t3code`, `t3code-nightly`                                                                                                                          | linux, macOS arm64     | Agent control surface (stable and nightly channels)                  |

...
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------- |
| [agave](#agave)                                                                                      | <!-- {~v_agave:"{{ v.agave_4_2 }}"} -->4.2.2<!-- {/v_agave} -->                                                      | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (mainnet, alias for agave-4_2) |
| [agave-4_3](#agave)                                                                                  | <!-- {~v_agave_4_3:"{{ v.agave_4_3 }}"} -->4.3.0<!-- {/v_agave_4_3} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.3.x release (alpha track)                           |
| [agave-4_2](#agave)                                                                                  | <!-- {~v_agave_4_2:"{{ v.agave_4_2 }}"} -->4.2.2<!-- {/v_agave_4_2} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.2.x release                                         |
| [agave-4_1](#agave)                                                                                  | <!-- {~v_agave_4_1:"{{ v.agave_4_1 }}"} -->4.1.2<!-- {/v_agave_4_1} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.1.x release                                         |
...
| [cargo-clean-all](#cargo-clean-all)                                                                  | <!-- {~v_cargo_clean_all:"{{ v.cargo_clean_all }}"} -->0.6.5<!-- {/v_cargo_clean_all} -->                            | linux, macos               | Recursively clean Cargo projects in a directory that match selected criteria     |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.157.1<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
| [deno](#deno)                                                                                        | <!-- {~v_deno:"{{ v.deno }}"} -->2.9.7<!-- {/v_deno} -->                                                             | linux, macos               | A modern runtime for JavaScript and TypeScript (with SHA-256SUMS verification)   |
...
| [dylint](#dylint)                                                                                    | <!-- {~v_dylint:"{{ v.dylint }}"} -->6.1.0<!-- {/v_dylint} -->                                                       | linux, macos               | Dylint tools for running Rust lints and building Dylint libraries                |
| [godot](#godot)                                                                                      | <!-- {~v_godot:"{{ v.godot }}"} -->4.7.2-stable<!-- {/v_godot} -->                                                   | linux, macos               | Free and open-source 2D and 3D game engine                                       |
| [gpg-suite](#gpg-suite)                                                                              | <!-- {~v_gpg_suite:"{{ v.gpg_suite }}"} -->2023.3<!-- {/v_gpg_suite} -->                                             | macos                      | GPG Suite - encryption, signing, and key management                              |
| [herdr](#herdr)                                                                                      | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.9.1<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.4.1-rc.2<!-- {/v_ironclaw} -->                                            | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
| [kani](#kani)                                                                                        | <!-- {~v_kani:"{{ v.kani }}"} -->0.68.0<!-- {/v_kani} -->                                                            | linux, macos               | Bit-precise model checker for Rust                                               |
| [knope](#knope)                                                                                      | <!-- {~v_knope:"{{ v.knope }}"} -->0.23.0<!-- {/v_knope} -->                                                         | linux, macos               | Automate common development tasks (changelogs, releases, versioning)             |
| [mdt](#mdt)                                                                                          | <!-- {~v_mdt:"{{ v.mdt }}"} -->0.9.5<!-- {/v_mdt} -->                                                                | linux, macos               | Update markdown content anywhere using comments as template tags                 |
| [melos](#melos), [melos-cli](#melos)                                                                 | <!-- {~v_melos:"{{ v.melos_8 }}"} -->8.9.0<!-- {/v_melos} -->                                                        | linux, macos               | Manage Dart and Flutter monorepos (default = melos_8)                            |
...
| [melos_8](#melos)                                                                                    | <!-- {~v_melos_8:"{{ v.melos_8 }}"} -->8.9.0<!-- {/v_melos_8} -->                                                    | linux, macos               | Melos pinned to the latest 8.x release                                           |
...
| [monostyle](#monostyle)                                                                              | <!-- {~v_monostyle:"{{ v.monostyle }}"} -->0.3.4<!-- {/v_monostyle} -->                                              | linux, macos               | Score the complexity and readability of a codebase, a file, or a function        |
| [nordvpn](#nordvpn)                                                                                  | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.11.0<!-- {/v_nordvpn} -->                                                  | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.34.4<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
| [op](#op)                                                                                            | <!-- {~v_op:"{{ v.op }}"} -->2.31.0-beta.01<!-- {/v_op} -->                                                          | linux, macos               | 1Password CLI beta channel with environment support                              |
| [patrol](#patrol_cli), [patrol-cli](#patrol_cli), [patrol_cli](#patrol_cli)                          | <!-- {~v_patrol_cli:"{{ v.patrol_cli }}"} -->4.7.0<!-- {/v_patrol_cli} -->                                           | linux, macos               | Command-line tool for Patrol, a Flutter-native UI testing framework              |
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.21.0<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->12.6.0<!-- {/v_pnpm} -->                                                            | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.5<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.27.1<!-- {/v_pnpm_11} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |
| [pnpm-standalone](#pnpm)                                                                             | <!-- {~v_pnpm_standalone:"{{ v.pnpm }}"} -->12.6.0<!-- {/v_pnpm_standalone} -->                                      | linux, macos               | Fast, disk-space efficient package manager (no Node.js dependency)               |
...
| [rive-cli](#rive-cli)                                                                                | <!-- {~v_rive_cli:"{{ v.rive_cli }}"} -->1.2.0<!-- {/v_rive_cli} -->                                                 | linux (x64), macos (arm64) | Build Rive animation projects from source (with offline docs and samples)        |
| [sbpf-linker](#sbpf-linker)                                                                          | <!-- {~v_sbpf_linker:"{{ v.sbpf_linker }}"} -->0.2.2<!-- {/v_sbpf_linker} -->                                        | linux, macos               | Upstream BPF linker for SBPF V0/V3 programs                                      |
...
| [solana-verify](#solana-verify)                                                                      | <!-- {~v_solana_verify:"{{ v.solana_verify }}"} -->0.5.2<!-- {/v_solana_verify} -->                                  | linux (x64), macos (arm64) | CLI tool for building verifiable Solana programs                                 |
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_4 }}"} -->4.0.3<!-- {/v_serverpod} -->                                        | linux, macos               | Command line tools for Serverpod (default 4.x track)                             |
| [serverpod_cli-3](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_3:"{{ v.serverpod_cli_3 }}"} -->3.4.13<!-- {/v_serverpod_cli_3} -->                           | linux, macos               | Serverpod CLI 3.x track                                                          |
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.3<!-- {/v_serverpod_cli_4} -->                            | linux, macos               | Serverpod CLI 4.x track (default aliases resolve here)                           |
...
| [t3code-nightly](#t3code)                                                                            | <!-- {~v_t3code_nightly:"{{ v.t3code_nightly }}"} -->0.0.43-nightly.20260926.2282<!-- {/v_t3code_nightly} -->        | linux, macos (arm64)       | T3 Code nightly channel (pre-release builds)                                     |
...
| [zoom](#zoom)                                                                                        | <!-- {~v_zoom:"{{ v.zoom }}"} -->7.2.1.88329<!-- {/v_zoom} -->                                                       | macos                      | Zoom video conferencing client                                                   |
...
- **Tracks:**
  - `agave` (mainnet = latest 4.2.x, alias: `solana`)
  - `agave-4_3` (alpha track)
  - `agave-4_2`
  - `agave-4_1`
  - `agave-4_0`
  - `agave-3_1`

...
| [agave-4_3](#agave)                                                                                  | <!-- {~v_agave_4_3:"{{ v.agave_4_3 }}"} -->4.3.0-rc.0<!-- {/v_agave_4_3} -->                                         | linux (x64), macos         | Agave pinned to the latest 4.3.x release (alpha track)                           |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.153.4<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.13.0<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
...
| [monosecret](#monosecret)                                                                            | <!-- {~v_monosecret:"{{ v.monosecret }}"} -->0.3.2<!-- {/v_monosecret} -->                                           | linux, macos               | Declarative secrets, every environment, any provider                             |
...
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0-rc.2<!-- {/v_serverpod_cli_4} -->                       | linux, macos               | Serverpod CLI 4.x beta track                                                     |

...
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------- |
| [agave](#agave)                                                                                      | <!-- {~v_agave:"{{ v.agave_4_2 }}"} -->4.2.1<!-- {/v_agave} -->                                                      | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (mainnet, alias for agave-4_2) |
| [agave-4_3](#agave)                                                                                  | <!-- {~v_agave_4_3:"{{ v.agave_4_3 }}"} -->4.3.0-beta.2<!-- {/v_agave_4_3} -->                                       | linux (x64), macos         | Agave pinned to the latest 4.3.x release (alpha track)                           |
| [agave-4_2](#agave)                                                                                  | <!-- {~v_agave_4_2:"{{ v.agave_4_2 }}"} -->4.2.1<!-- {/v_agave_4_2} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.2.x release                                         |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.150.1<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
| [deno](#deno)                                                                                        | <!-- {~v_deno:"{{ v.deno }}"} -->2.9.5<!-- {/v_deno} -->                                                             | linux, macos               | A modern runtime for JavaScript and TypeScript (with SHA-256SUMS verification)   |
...
| [herdr](#herdr)                                                                                      | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.8.2<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.4.0-rc.1<!-- {/v_ironclaw} -->                                            | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [mdt](#mdt)                                                                                          | <!-- {~v_mdt:"{{ v.mdt }}"} -->0.9.1<!-- {/v_mdt} -->                                                                | linux, macos               | Update markdown content anywhere using comments as template tags                 |
...
| [monochange](#monochange)                                                                            | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.9.2<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |
| [nordvpn](#nordvpn)                                                                                  | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.9.0<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.33.1<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.12.2<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.24.0<!-- {/v_pnpm} -->                                                           | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.5<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.24.0<!-- {/v_pnpm_11} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |
...
| [monosecret](#monosecret)                                                                            | <!-- {~v_monosecret:"{{ v.monosecret }}"} -->0.2.1<!-- {/v_monosecret} -->                                           | linux, macos               | Declarative secrets, every environment, any provider                             |
| [solana](#agave)                                                                                     | <!-- {~v_solana:"{{ v.agave_4_2 }}"} -->4.2.1<!-- {/v_solana} -->                                                    | linux (x64), macos         | Alias for agave-4_2 (Solana validator client and CLI for mainnet)                |
...
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_3 }}"} -->3.4.12<!-- {/v_serverpod} -->                                       | linux, macos               | Command line tools for Serverpod (default 3.x track)                             |
| [serverpod_cli-3](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_3:"{{ v.serverpod_cli_3 }}"} -->3.4.12<!-- {/v_serverpod_cli_3} -->                           | linux, macos               | Serverpod CLI stable 3.x track                                                   |
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0-rc.1<!-- {/v_serverpod_cli_4} -->                       | linux, macos               | Serverpod CLI 4.x beta track                                                     |
| [steam](#steam)                                                                                      | <!-- {~v_steam:"{{ v.steam }}"} -->4.0<!-- {/v_steam} -->                                                            | macos                      | Steam video game digital distribution service                                    |
| [surfpool](#surfpool)                                                                                | <!-- {~v_surfpool:"{{ v.surfpool }}"} -->1.5.0<!-- {/v_surfpool} -->                                                 | linux (x64), macos         | A drop-in replacement for solana-test-validator with mainnet state simulation    |

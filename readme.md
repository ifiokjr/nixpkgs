...
| [monochange](#monochange)                                                                            | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.11.1<!-- {/v_monochange} -->                                          | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |
...
| [monosecret](#monosecret)                                                                            | <!-- {~v_monosecret:"{{ v.monosecret }}"} -->0.3.4<!-- {/v_monosecret} -->                                           | linux, macos               | Declarative secrets, every environment, any provider                             |

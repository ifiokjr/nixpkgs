...
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.10.0<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
...
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0-beta.4<!-- {/v_serverpod_cli_4} -->                     | linux, macos               | Serverpod CLI 4.x beta track                                                     |

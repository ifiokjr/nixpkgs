...
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------- |
| [agave](#agave)                                                                                      | <!-- {~v_agave:"{{ v.agave_4_0 }}"} -->4.0.1<!-- {/v_agave} -->                                                      | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (mainnet, alias for agave-4_0) |
| [agave-4_0](#agave)                                                                                  | <!-- {~v_agave_4_0:"{{ v.agave_4_0 }}"} -->4.0.1<!-- {/v_agave_4_0} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.0.x release                                         |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.136.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [herdr](#herdr)                                                                                      | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.6.6<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |
...
| [monochange](#monochange)                                                                            | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.7.0<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |
| [nordvpn](#nordvpn)                                                                                  | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.3.1<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.30.2<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.5.1<!-- {/v_pnpm} -->                                                            | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.1<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.5.1<!-- {/v_pnpm_11} -->                                                   | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |
...
| [solana](#agave)                                                                                     | <!-- {~v_solana:"{{ v.agave_4_0 }}"} -->4.0.1<!-- {/v_solana} -->                                                    | linux (x64), macos         | Alias for agave-4_0 (Solana validator client and CLI for mainnet)                |
| [solana-verify](#solana-verify)                                                                      | <!-- {~v_solana_verify:"{{ v.solana_verify }}"} -->0.5.0<!-- {/v_solana_verify} -->                                  | linux (x64), macos (arm64) | CLI tool for building verifiable Solana programs                                 |
...
| [surfpool](#surfpool)                                                                                | <!-- {~v_surfpool:"{{ v.surfpool }}"} -->1.3.0<!-- {/v_surfpool} -->                                                 | linux (x64), macos         | A drop-in replacement for solana-test-validator with mainnet state simulation    |

...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.157.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [rive-cli](#rive-cli)                                                                                | <!-- {~v_rive_cli:"{{ v.rive_cli }}"} -->1.1.1<!-- {/v_rive_cli} -->                                                 | linux (x64), macos (arm64) | Build Rive animation projects from source (with offline docs and samples)        |
...
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_4 }}"} -->4.0.2<!-- {/v_serverpod} -->                                        | linux, macos               | Command line tools for Serverpod (default 4.x track)                             |
...
| [t3code-nightly](#t3code)                                                                            | <!-- {~v_t3code_nightly:"{{ v.t3code_nightly }}"} -->0.0.43-nightly.20260925.2237<!-- {/v_t3code_nightly} -->        | linux, macos (arm64)       | T3 Code nightly channel (pre-release builds)                                     |

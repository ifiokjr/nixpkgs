...
| [deno](#deno)                                         | <!-- {~v_deno:"{{ v.deno }}"} -->2.8.0<!-- {/v_deno} -->                                                             | linux, macos               | A modern runtime for JavaScript and TypeScript (with SHA-256SUMS verification)   |
...
| [monochange](#monochange)                             | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.6.2<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |

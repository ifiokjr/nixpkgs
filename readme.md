...
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------- |
| [agave](#agave)                                                                                      | <!-- {~v_agave:"{{ v.agave_4_2 }}"} -->4.2.0<!-- {/v_agave} -->                                                      | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (mainnet, alias for agave-4_2) |
...
| [agave-4_2](#agave)                                                                                  | <!-- {~v_agave_4_2:"{{ v.agave_4_2 }}"} -->4.2.0<!-- {/v_agave_4_2} -->                                              | linux (x64), macos         | Agave pinned to the latest 4.2.x release                                         |
...
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.2.0-rc.3<!-- {/v_ironclaw} -->                                            | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.9<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [solana](#agave)                                                                                     | <!-- {~v_solana:"{{ v.agave_4_2 }}"} -->4.2.0<!-- {/v_solana} -->                                                    | linux (x64), macos         | Alias for agave-4_2 (Solana validator client and CLI for mainnet)                |

...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------------------------------- |
| [agave](#agave)                                       | <!-- {~v_agave:"{{ v.agave }}"} -->3.1.11<!-- {/v_agave} -->                                                         | linux (x64), macos | Solana validator client and CLI toolchain by Anza (latest 3.1.x track)        |
| [agave-3_1](#agave)                                   | <!-- {~v_agave_3_1:"{{ v.agave }}"} -->3.1.11<!-- {/v_agave_3_1} -->                                                 | linux (x64), macos | Agave pinned to the latest 3.1.x release                                      |
...
| [codex-cli](#codex-cli)                               | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.117.0<!-- {/v_codex_cli} -->                                            | linux, macos       | OpenAI Codex CLI - AI coding assistant for the terminal                       |
...
| [cursor-cli](#cursor-cli)                             | <!-- {~v_cursor_cli:"{{ v.cursor_cli }}"} -->2026.03.25-933d5a6<!-- {/v_cursor_cli} -->                              | linux, macos       | Cursor AI CLI agent for terminal-based development                            |
| [godot](#godot)                                       | <!-- {~v_godot:"{{ v.godot }}"} -->4.6.1-stable<!-- {/v_godot} -->                                                   | linux, macos       | Free and open-source 2D and 3D game engine                                    |
...
| [pina](#pina)                                         | <!-- {~v_pina:"{{ v.pina }}"} -->0.7.0<!-- {/v_pina} -->                                                             | linux, macos       | CLI for Pina, a performant Solana smart contract framework                    |

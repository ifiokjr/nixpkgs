...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------------------------------- |
| [agave](#agave)                                       | <!-- {~v_agave:"{{ v.agave }}"} -->3.1.12<!-- {/v_agave} -->                                                         | linux (x64), macos | Solana validator client and CLI toolchain by Anza (latest 3.1.x track)        |
| [agave-3_1](#agave)                                   | <!-- {~v_agave_3_1:"{{ v.agave }}"} -->3.1.12<!-- {/v_agave_3_1} -->                                                 | linux (x64), macos | Agave pinned to the latest 3.1.x release                                      |
...
| [nordvpn](#nordvpn)                                   | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.0.1<!-- {/v_nordvpn} -->                                                   | macos              | NordVPN macOS client                                                          |

...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.156.1<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [mdt](#mdt)                                                                                          | <!-- {~v_mdt:"{{ v.mdt }}"} -->0.9.4<!-- {/v_mdt} -->                                                                | linux, macos               | Update markdown content anywhere using comments as template tags                 |
...
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.20.0<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
...
| [t3code-nightly](#t3code)                                                                            | <!-- {~v_t3code_nightly:"{{ v.t3code_nightly }}"} -->0.0.43-nightly.20260924.2187<!-- {/v_t3code_nightly} -->        | linux, macos (arm64)       | T3 Code nightly channel (pre-release builds)                                     |

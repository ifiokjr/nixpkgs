...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.146.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
| [deno](#deno)                                                                                        | <!-- {~v_deno:"{{ v.deno }}"} -->2.9.4<!-- {/v_deno} -->                                                             | linux, macos               | A modern runtime for JavaScript and TypeScript (with SHA-256SUMS verification)   |
...
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.1.0-rc.1<!-- {/v_ironclaw} -->                                                | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
| [kani](#kani)                                                                                        | <!-- {~v_kani:"{{ v.kani }}"} -->0.67.0<!-- {/v_kani} -->                                                            | linux, macos               | Bit-precise model checker for Rust                                               |
| [keyring](#keyring)                                                                                  | <!-- {~v_keyring:"{{ v.keyring }}"} -->4.1.5<!-- {/v_keyring} -->                                                    | linux, macos               | Sample code and CLI for the Rust Keyring                                         |
...
| [nordvpn](#nordvpn)                                                                                  | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.8.0<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.5<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.20.0<!-- {/v_pnpm} -->                                                           | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.5<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.20.0<!-- {/v_pnpm_11} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |

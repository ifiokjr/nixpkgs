...
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.1.1-rc.1<!-- {/v_ironclaw} -->                                            | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.8<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_3 }}"} -->3.4.8<!-- {/v_serverpod} -->                                        | linux, macos               | Command line tools for Serverpod (default 3.x track)                             |
| [serverpod_cli-3](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_3:"{{ v.serverpod_cli_3 }}"} -->3.4.8<!-- {/v_serverpod_cli_3} -->                            | linux, macos               | Serverpod CLI stable 3.x track                                                   |
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0-beta.1<!-- {/v_serverpod_cli_4} -->                     | linux, macos               | Serverpod CLI 4.x beta track                                                     |

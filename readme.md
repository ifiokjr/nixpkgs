...
| [pnpm](#pnpm)                                         | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.1.3<!-- {/v_pnpm} -->                                                            | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)          |
| [pnpm-10](#pnpm)                                      | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.33.2<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                        |
| [pnpm-11](#pnpm)                                      | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.1.3<!-- {/v_pnpm_11} -->                                                   | linux, macos               | Standalone pnpm pinned to the latest v11 release track                        |

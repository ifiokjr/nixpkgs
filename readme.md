...
| [agave-4_3](#agave)                                                                                  | <!-- {~v_agave_4_3:"{{ v.agave_4_3 }}"} -->4.3.0-alpha.3<!-- {/v_agave_4_3} -->                                      | linux (x64), macos         | Agave pinned to the latest 4.3.x release (alpha track)                           |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.147.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [dylint](#dylint)                                                                                    | <!-- {~v_dylint:"{{ v.dylint }}"} -->6.0.3<!-- {/v_dylint} -->                                                       | linux, macos               | Dylint tools for running Rust lints and building Dylint libraries                |
| [godot](#godot)                                                                                      | <!-- {~v_godot:"{{ v.godot }}"} -->4.7.1-stable<!-- {/v_godot} -->                                                   | linux, macos               | Free and open-source 2D and 3D game engine                                       |
| [gpg-suite](#gpg-suite)                                                                              | <!-- {~v_gpg_suite:"{{ v.gpg_suite }}"} -->2023.3<!-- {/v_gpg_suite} -->                                             | macos                      | GPG Suite - encryption, signing, and key management                              |
| [herdr](#herdr)                                                                                      | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.8.0<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.2.0<!-- {/v_ironclaw} -->                                                 | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
| [kani](#kani)                                                                                        | <!-- {~v_kani:"{{ v.kani }}"} -->0.67.0<!-- {/v_kani} -->                                                            | linux, macos               | Bit-precise model checker for Rust                                               |
| [keyring](#keyring)                                                                                  | <!-- {~v_keyring:"{{ v.keyring }}"} -->4.1.6<!-- {/v_keyring} -->                                                    | linux, macos               | Sample code and CLI for the Rust Keyring                                         |
| [knope](#knope)                                                                                      | <!-- {~v_knope:"{{ v.knope }}"} -->0.23.0<!-- {/v_knope} -->                                                         | linux, macos               | Automate common development tasks (changelogs, releases, versioning)             |
| [mdt](#mdt)                                                                                          | <!-- {~v_mdt:"{{ v.mdt }}"} -->0.9.0<!-- {/v_mdt} -->                                                                | linux, macos               | Update markdown content anywhere using comments as template tags                 |
...
| [monochange](#monochange)                                                                            | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.8.4<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |
| [nordvpn](#nordvpn)                                                                                  | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.8.1<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.11<!-- {/v_ollama} -->                                                     | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.21.0<!-- {/v_pnpm} -->                                                           | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.5<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.21.0<!-- {/v_pnpm_11} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |
...
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_3 }}"} -->3.4.11<!-- {/v_serverpod} -->                                       | linux, macos               | Command line tools for Serverpod (default 3.x track)                             |
| [serverpod_cli-3](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_3:"{{ v.serverpod_cli_3 }}"} -->3.4.11<!-- {/v_serverpod_cli_3} -->                           | linux, macos               | Serverpod CLI stable 3.x track                                                   |
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0-beta.2<!-- {/v_serverpod_cli_4} -->                     | linux, macos               | Serverpod CLI 4.x beta track                                                     |

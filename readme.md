...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------------------------- |
| [agave](#agave)                                       | <!-- {~v_agave:"{{ v.agave_4_0 }}"} -->4.0.0<!-- {/v_agave} -->                                                      | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (mainnet, alias for agave-4_0) |
...
| [deno](#deno)                                         | <!-- {~v_deno:"{{ v.deno }}"} -->2.8.1<!-- {/v_deno} -->                                                             | linux, macos               | A modern runtime for JavaScript and TypeScript (with SHA-256SUMS verification)   |
| [flutter_launcher_icons](#flutter_launcher_icons)     | <!-- {~v_flutter_launcher_icons:"{{ v.flutter_launcher_icons }}"} -->0.14.4<!-- {/v_flutter_launcher_icons} -->      | linux, macos               | Generate launcher icons for Flutter apps                                         |
| [flutter_native_splash](#flutter_native_splash)       | <!-- {~v_flutter_native_splash:"{{ v.flutter_native_splash }}"} -->2.4.8<!-- {/v_flutter_native_splash} -->          | linux, macos               | Generate native splash screens for Flutter apps                                  |
...
| [herdr](#herdr)                                       | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.6.0<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |
| [ironclaw](#ironclaw)                                 | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->0.29.0<!-- {/v_ironclaw} -->                                                | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [melos](#melos)                                       | <!-- {~v_melos:"{{ v.melos }}"} -->7.8.0<!-- {/v_melos} -->                                                          | linux, macos               | Manage Dart and Flutter monorepos with multiple packages                         |
| [monochange](#monochange)                             | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.6.8<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                     |
| [nordvpn](#nordvpn)                                   | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.2.0<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                             |
| [ollama](#ollama)                                     | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.24.0<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pnpm](#pnpm)                                         | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.2.2<!-- {/v_pnpm} -->                                                            | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                      | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.33.4<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                      | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.2.2<!-- {/v_pnpm_11} -->                                                   | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |
...
| [solana](#agave)                                      | <!-- {~v_solana:"{{ v.agave_4_0 }}"} -->4.0.0<!-- {/v_solana} -->                                                    | linux (x64), macos         | Alias for agave-4_0 (Solana validator client and CLI for mainnet)                |
...
| [serverpod_cli](#serverpod_cli)                       | <!-- {~v_serverpod_cli:"{{ v.serverpod_cli }}"} -->3.4.8<!-- {/v_serverpod_cli} -->                                  | linux, macos               | Command line tools for Serverpod                                                 |
...
| [zoom](#zoom)                                         | <!-- {~v_zoom:"{{ v.zoom }}"} -->7.0.5.81138<!-- {/v_zoom} -->                                                       | macos                      | Zoom video conferencing client                                                   |

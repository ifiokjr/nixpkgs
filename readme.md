...
| [melos](#melos), [melos-cli](#melos)                                                                 | <!-- {~v_melos:"{{ v.melos_8 }}"} -->8.8.0<!-- {/v_melos} -->                                                        | linux, macos               | Manage Dart and Flutter monorepos (default = melos_8)                            |
...
| [rive-cli](#rive-cli)                                                                                | <!-- {~v_rive_cli:"{{ v.rive_cli }}"} -->1.1.0<!-- {/v_rive_cli} -->                                                 | linux (x64), macos (arm64) | Build Rive animation projects from source (with offline docs and samples)        |
...
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.1<!-- {/v_serverpod_cli_4} -->                            | linux, macos               | Serverpod CLI 4.x beta track                                                     |

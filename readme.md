...
| [agave-4_3](#agave)                                                                                  | <!-- {~v_agave_4_3:"{{ v.agave_4_3 }}"} -->4.3.0-beta.0<!-- {/v_agave_4_3} -->                                       | linux (x64), macos         | Agave pinned to the latest 4.3.x release (alpha track)                           |
...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.148.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.3.0-rc.2<!-- {/v_ironclaw} -->                                            | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.14<!-- {/v_ollama} -->                                                     | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
...
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->11.22.0<!-- {/v_pnpm} -->                                                           | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
| [pnpm-10](#pnpm)                                                                                     | <!-- {~v_pnpm_10:"{{ v.pnpm_10 }}"} -->10.34.5<!-- {/v_pnpm_10} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v10 release track                           |
| [pnpm-11](#pnpm)                                                                                     | <!-- {~v_pnpm_11:"{{ v.pnpm_11 }}"} -->11.22.0<!-- {/v_pnpm_11} -->                                                  | linux, macos               | Standalone pnpm pinned to the latest v11 release track                           |

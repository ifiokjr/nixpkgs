...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.155.1<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [monostyle](#monostyle)                                                                              | <!-- {~v_monostyle:"{{ v.monostyle }}"} -->0.2.0<!-- {/v_monostyle} -->                                              | linux, macos               | Score the complexity and readability of a codebase, a file, or a function        |
...
| [pina](#pina)                                                                                        | <!-- {~v_pina:"{{ v.pina }}"} -->0.19.0<!-- {/v_pina} -->                                                            | linux, macos               | CLI for Pina, a performant Solana smart contract framework                       |
...
| [serverpod](#serverpod_cli), [serverpod-cli](#serverpod_cli), [serverpod_cli](#serverpod_cli)        | <!-- {~v_serverpod:"{{ v.serverpod_cli_3 }}"} -->3.4.13<!-- {/v_serverpod} -->                                       | linux, macos               | Command line tools for Serverpod (default 3.x track)                             |
| [serverpod_cli-3](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_3:"{{ v.serverpod_cli_3 }}"} -->3.4.13<!-- {/v_serverpod_cli_3} -->                           | linux, macos               | Serverpod CLI stable 3.x track                                                   |
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.1.0-beta.1<!-- {/v_serverpod_cli_4} -->                     | linux, macos               | Serverpod CLI 4.x beta track                                                     |

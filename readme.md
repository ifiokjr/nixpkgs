...
| [codex-cli](#codex-cli)                               | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.120.0<!-- {/v_codex_cli} -->                                            | linux, macos             | OpenAI Codex CLI - AI coding assistant for the terminal                       |
...
| [cursor-cli](#cursor-cli)                             | <!-- {~v_cursor_cli:"{{ v.cursor_cli }}"} -->2026.04.14-ee4b43a<!-- {/v_cursor_cli} -->                              | linux, macos             | Cursor AI CLI agent for terminal-based development                            |
...
| [nordvpn](#nordvpn)                                   | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.0.3<!-- {/v_nordvpn} -->                                                   | macos                    | NordVPN macOS client                                                          |
| [ollama](#ollama)                                     | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.20.7<!-- {/v_ollama} -->                                                      | linux, macos             | Run local LLMs with Ollama via CLI and desktop app                            |

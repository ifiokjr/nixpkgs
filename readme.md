...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------------------------------- |
| [agave](#agave)                                       | <!-- {~v_agave:"{{ v.agave }}"} -->3.1.14<!-- {/v_agave} -->                                                         | linux (x64), macos         | Solana validator client and CLI toolchain by Anza (latest 3.1.x track)        |
...
| [agave-3_1](#agave)                                   | <!-- {~v_agave_3_1:"{{ v.agave }}"} -->3.1.14<!-- {/v_agave_3_1} -->                                                 | linux (x64), macos         | Agave pinned to the latest 3.1.x release                                      |
...
| [codex-cli](#codex-cli)                               | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.128.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                       |
...
| [monochange](#monochange)                             | <!-- {~v_monochange:"{{ v.monochange }}"} -->0.3.0<!-- {/v_monochange} -->                                           | linux, macos               | Manage versions and releases for your multiplatform monorepo                  |
| [nordvpn](#nordvpn)                                   | <!-- {~v_nordvpn:"{{ v.nordvpn }}"} -->10.1.0<!-- {/v_nordvpn} -->                                                   | macos                      | NordVPN macOS client                                                          |
| [ollama](#ollama)                                     | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.22.1<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                            |

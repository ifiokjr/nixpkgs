...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.144.6<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [herdr](#herdr)                                                                                      | <!-- {~v_herdr:"{{ v.herdr }}"} -->0.7.4<!-- {/v_herdr} -->                                                          | linux, macos               | Terminal agent multiplexer - tmux for coding agents                              |

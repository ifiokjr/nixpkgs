...
| [codex-cli](#codex-cli)                                                                              | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.155.0<!-- {/v_codex_cli} -->                                            | linux, macos               | OpenAI Codex CLI - AI coding assistant for the terminal                          |
...
| [pnpm](#pnpm)                                                                                        | <!-- {~v_pnpm:"{{ v.pnpm }}"} -->12.4.2<!-- {/v_pnpm} -->                                                            | linux, macos               | Fast, disk-space efficient package manager (latest standalone track)             |
...
| [rive-cli](#rive-cli)                                                                                | <!-- {~v_rive_cli:"{{ v.rive_cli }}"} -->1.0.4<!-- {/v_rive_cli} -->                                                 | linux (x64), macos (arm64) | Build Rive animation projects from source (with offline docs and samples)        |
...
| [serverpod_cli-4](#serverpod_cli)                                                                    | <!-- {~v_serverpod_cli_4:"{{ v.serverpod_cli_4 }}"} -->4.0.0<!-- {/v_serverpod_cli_4} -->                            | linux, macos               | Serverpod CLI 4.x beta track                                                     |

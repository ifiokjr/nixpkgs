...
| [codex-cli](#codex-cli)                               | <!-- {~v_codex_cli:"{{ v.codex_cli }}"} -->0.116.0<!-- {/v_codex_cli} -->                                            | linux, macos       | OpenAI Codex CLI - AI coding assistant for the terminal                       |
...
| [cursor-cli](#cursor-cli)                             | <!-- {~v_cursor_cli:"{{ v.cursor_cli }}"} -->2026.03.20-44cb435<!-- {/v_cursor_cli} -->                              | linux, macos       | Cursor AI CLI agent for terminal-based development                            |
...
| [pina](#pina)                                         | <!-- {~v_pina:"{{ v.pina }}"} -->0.6.0<!-- {/v_pina} -->                                                             | linux, macos       | CLI for Pina, a performant Solana smart contract framework                    |

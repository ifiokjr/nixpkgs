...
| [ironclaw](#ironclaw)                                                                                | <!-- {~v_ironclaw:"{{ v.ironclaw }}"} -->1.1.0<!-- {/v_ironclaw} -->                                                | linux, macos               | Agent OS focused on privacy, security, and extensibility (NEAR AI)               |
...
| [ollama](#ollama)                                                                                    | <!-- {~v_ollama:"{{ v.ollama }}"} -->0.32.6<!-- {/v_ollama} -->                                                      | linux, macos               | Run local LLMs with Ollama via CLI and desktop app                               |
